...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=\linewidth]{PracticalFlow.png}
...
\begin{figure}[!htb]
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=.7\linewidth]{LocalSend.png}
		\caption{Same network packet sent.}\label{fig:fig4}
	\end{minipage}\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=.7\linewidth]{LocalReceive.png}
...
\begin{figure}[!htb]
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=.7\linewidth]{PublicSend.png}
		\caption{Public ip packet sent.}\label{fig:fig6}
	\end{minipage}\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=.7\linewidth]{PublicReceive.png}
...
% preinstalled, to install, what was used
